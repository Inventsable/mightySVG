...
// function myT.readFiles(path, ...args){
//   path = smartPath(path);
//   var mirror = [];
//   for (var i = 0; i < args.length; i++) {
//     if (hasArray(args[i])) {
...
// myT.writeFiles('./log', ['main.js', 'style.css'], [JScontent, CSScontent])
// function myT.writeFiles(path, paths=[], contents=[]){
//   path = smartPath(path);
//   var errors = [];
//   paths.forEach(function(v,i,a){
//     var rewrite = myT.writeFile(path, v, contents[i]);
...
// function myT.deleteFiles(path, ...args){
//   path = smartPath(path);
//   var mirror = [];
//   for (var i = 0; i < args.length; i++) {
//     if (hasArray(args[i])) {
...
// myT.copyFile(path, name [, newName])
//            ( path  ,  name )
// myT.copyFile('./CSXS', 'manifest.xml')

//            ( path  ,  name  ,  new name  )
// myT.copyFile('./log', 'item.svg', 'newItem.svg')

//          (  path  ,  name  ,    new path,   new name  )
// myT.copyFile('./log', 'item.svg', './client/css', 'cool.svg')

// function myT.copyFile(path, ...args){
//   path = smartPath(path);
//   var original, newName;
//   if (args.length > 2) {
//     original = args[0];
